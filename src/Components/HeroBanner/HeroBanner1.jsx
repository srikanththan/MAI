...
const HeroBanner1 = ({title,content,btnname,btnurl,btntwo,btn2url,img}) => {
    return (
                    ...
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-xl-5 order-1 order-xl-2">
                                <div className="intro-thumb" style={{ marginLeft: '-40px' }}>
