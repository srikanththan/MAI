...
const ContactInfo = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs.sendForm('service_si299qx', 'template_xa1mn78', form.current, 'OK0cdEsYwyzX55VMQ')
            .then((result) => {
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="contact-info-box style1">
                                    <div className="contact-content">
                                        ...
                                        <a className="text" href="#">Banjara Hills, Hyderabad</a>
                                    </div>
                                </div>
                            </div>
                            <div className="col-xl-4 col-md-6">
                                <div className="contact-info-box style1">
                                    <div className="contact-content">
                                        ...
                                        <h3 className="title">
                                            <a href="mailto:support@metanovaai.com"> support@metanovaai.com</a>
                                        </h3>

                                        <p className="text">Email us any time for any kind of query.</p>
                            ...
                            <div className="col-xl-4 col-md-6">
                                <div className="contact-info-box style1">
                                    <div className="contact-content">
                                        ...
                                        <h3 className="title">
                                            <a href="tel:34534534543"> IND: +919618089966 </a> <br />
                                            <a href= "tel:+1-7739999884"> US: +17739999884</a>
                                        </h3>

                                        <p className="text">Contact us for any support you need — we’re here and ready to assist.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="row gy-5 gx-60">
                            <div className="col-xl-6">
                                <div className="contact-map">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15227.654320940053!2d78.42548726060218!3d17.415934485615857!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb9728e7c230a5%3A0xbf59752f5f7caa0!2sBanjara%20Hills%2C%20Hyderabad%2C%20Telangana!5e0!3m2!1sen!2sin!4v1741865922316!5m2!1sen!2sin"
                                         loading="lazy"
                                        ></iframe>
                                </div>
                            ...
                            <div className="col-xl-6">
                                <div className="contact-form style1" id="get-started-section">
                                    <h2 className="contact-title">
                                        Ready to Get Started?
                                    </h2>
                                    <p className="desc">Let us know how we can help you implement AI solutions in your business.</p>
                                    ...
                                    <form ref={form} onSubmit={sendEmail} className="contact-form-items">
                                        <div className="row g-4">
                                            ...
                                            <div className="col-lg-7 wow fadeInUp" data-wow-delay=".9s">
                                                <button type="submit" className="theme-btn" disabled={submitStatus.message === 'Sending...'}>
                                                    {submitStatus.message === 'Sending...' ? 'Sending...' : 'Send Message'} 
