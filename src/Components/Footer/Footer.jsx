                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6 wow fadeInUp" data-wow-delay=".2s">
                            <div className="single-footer-widget">
                                <div className="widget-head">
                                    <Link to="/">
                                        <img src="/assets/images/logo/final_logo.png" alt="logo-img" />
                                    </Link>
                                </div>
                                <div className="footer-content">
                                    <p>
                                    Let’s Build AI Solutions That Drive Real Business Impact.
                        ...
                        <div className="col-xl-4 col-lg-4 col-md-6">
                            <div className="single-footer-widget">
                                <div className="contact-box">
                                    ...
                                    <div className="text">Banjara Hills, Hyderabad, 500001</div>
                                    <div className="widget-head">Ready to get started?</div>
                                    <div className="text">Artificial intelligence is not here to replace us, but to amplify our potential, turning imagination into innovation.</div>
                                    <div className="info">
                                        <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="23"
                                                ...
                                                <path
                                                    ...
                                                    stroke="#02577a" strokeWidth="2" strokeLinecap="round"
                                                    strokeLinejoin="round" />
                                                <path d="M20.1667 6L11 12.4167L1.83337 6" stroke="#02577a" strokeWidth="2"
                                                    strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                        </div>
                                        <div className="link">
                                            <a href="mailto:support@metanovaai.com">support@metanovaai.com</a> <br/>
                                    ...
                                    <div className="info">
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="23"
                                                ...
                                                <g clipPath="url(#clip0_2011_91)">
                                                    <path
                                                        ...
                                                        stroke="#005073" strokeWidth="2" strokeLinecap="round"
                                                        strokeLinejoin="round" />
                                                </g>
                                                <defs>
                                        ...
                                        <div className="link">
                                            <a href="tel:21314234323543">+91 - 9618089966 </a> <br/>
                                            <a href="tel:35234523452345">+1 - 7739999884</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="container">
                    <div className="footer-wrapper d-flex align-items-center justify-content-between">
                        <p className="wow fadeInLeft" data-wow-delay=".3s">
                            Copyright © MetaNova AI | All rights reserved.
